...
def espaloma(MONOMER,XML_FILEPATH,TYPED_FILEPATH,DIMER=False):
    ...
    '''Create an OpenMM Molecule object from mBuild Compound 
    and run BondWalker Function to restore double bonds.'''
    ...
    '''Run OpenMM Molecule through espaloma code'''
    ...
    '''rename the atoms in the mBuild Compound to match espaloma forcefield 
    and remove extra dimer from molecule object:'''
    ...
    '''write the forcefield parameters into an XML file:'''
    mbuild_to_foyer_xml(
    ...
    '''Create an mol2 file with the correct atom types corresponding to the espaloma forcefield'''
